...
if __name__ == "__main__":
    ...
    main_parser.add_argument("--mode", choices=["text_to_gloss", "pose_to_video", "text_to_gloss_to_pose", "text_to_gloss_to_pose_to_video"], required=True)
    args, remaining_argv = main_parser.parse_known_args()
    if args.mode == "text_to_gloss":
        sys.argv = [sys.argv[0]] + remaining_argv
        text_to_gloss()
    elif args.mode == "pose_to_video":
        sys.argv = [sys.argv[0]] + remaining_argv
        pose_to_video()
    elif args.mode == "text_to_gloss_to_pose":
        sys.argv = [sys.argv[0]] + remaining_argv
        text_to_gloss_to_pose()
    elif args.mode == "text_to_gloss_to_pose_to_video":
        sys.argv = [sys.argv[0]] + remaining_argv
